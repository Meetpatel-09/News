                ...
                if (ds1 != null && ds1.Tables[0].Rows.Count > 0)
                {
                    for (int j = v; j < v1; j++)
                    {
                        ...
                        if (j < k)
                        {
                            ...
                            lreportername1.Text = dr1["fname"].ToString();
                        ...
                        if ((j + 1) < k)
                        {
                            ...
                            lreportername2.Text = dr2["fname"].ToString();
                        ...
                        if ((j + 2) < k)
                        {
                            ...
                            lreportername3.Text = dr3["fname"].ToString();
                        ...
                        if ((j + 3) < k)
                        {
                            ...
                            lreportername4.Text = dr4["fname"].ToString();
                        ...
                        if ((j + 4) < k)
                        {
                            ...
                            lreportername5.Text = dr5["fname"].ToString();
                        ...
                        if ((j + 5) < k)
                        {
                            ...
                            lreportername6.Text = dr6["fname"].ToString();
                   ...
                   //         lmsg.Visible = true;
                        ...
                        if ((j + 6) < k)
                        {
                            ...
                            lreportername7.Text = dr7["fname"].ToString();
                        ...
                        if ((j + 7) < k)
                        {
                            ...
                            lreportername8.Text = dr8["fname"].ToString();
                       ...
                       //     lmsg.Visible = true;
                        ...
                        if ((j + 8) < k)
                        {
                            ...
                            lreportername9.Text = dr9["fname"].ToString();
                        ...
                        if ((j + 9) < k)
                        {
                            ...
                            lreportername10.Text = dr10["fname"].ToString();
