<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="loginUser.aspx.cs" Inherits="loginUser" %>
							...
							<div class="row">
                                <div class="col-lg-12">
										...
										<div class="justify-content-md-center">
                                    		<h4 style="text-align: center"> User Sign In</h4>
										</div>
										&nbsp; Email
