<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="manage_reporter_single.aspx.cs" Inherits="manage_reporter_single" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="w-100">
        ...
        <tr>
            ...
            <td class="style1">
                <span style="color: rgb(33, 33, 33); font-family: Roboto, Arial, sans-serif; font-size: large; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 500; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">
                Upload New Resume</span></td>
            <td class="auto-style2">
                <asp:Button ID="btUploadResumer" runat="server" OnClick="btUploadResumer_Click" Text="Upload" CssClass="btn btn-primary" />
                </td>
            <td class="style1">
                &nbsp;</td>
            <td class="style1">
        ...
        <tr>
            ...
            <td class="style1">
                &nbsp;</td>
            <td class="auto-style2">
                <asp:FileUpload ID="FileUpload2" runat="server" Width="165px" style="display: none" />
                </td>
            <td class="style1">
                &nbsp;</td>
            <td class="style1">
